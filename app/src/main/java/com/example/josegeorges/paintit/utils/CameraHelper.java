...
public class CameraHelper {
    ...
    public static Camera.Size getBestPreviewSize(List<Camera.Size> sizes, int layoutWidth, int layoutHeight, boolean isPortrait) {
        //If portrait mode inverse surfaceWidth and surfaceHeight, since the sizes are all in landscape mode.
        if (isPortrait) {
            layoutHeight = layoutHeight + layoutWidth; //   E.g 80 + 40 = 120
            layoutWidth = layoutHeight - layoutWidth; //        120 - 40 = 80
            layoutHeight = layoutHeight - layoutWidth; //       120 - 80 = 40
        }
